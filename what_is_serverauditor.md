...
> ***!*** Serverauditor is fully functional, add-free and a free to download. [Serverauditor Premium](premium.md) is delivered with extended functionality such as SFTP and Cross-Platform sync. It is available under a subscription-based licensing model for $6 (US) a year. A subscription can be purchased in-app. 
